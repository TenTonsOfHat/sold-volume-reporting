WITH TradeEntryVolumeData AS (
    ...
    AND te.OrderAcceptedDateTime >= DATEADD(MONTH, -1, DATEADD(MONTH, DATEDIFF(MONTH, 0, GETDATE()), 0))
    AND te.OrderAcceptedDateTime < DATEADD(MONTH, DATEDIFF(MONTH, 0, GETDATE()), 0)
